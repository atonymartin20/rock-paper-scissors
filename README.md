...
I've been planning on building a simple Rock Paper Scissors Game for a while.  When I found this framework for the project on Frontend Mentor, I thought it would be an interesting project to build.  They supplied me with the style-guide, design images,  and the image assets and I built the rest.  Rock Paper Scissors has 2 modes.  First is basic mode which is your typical rock paper scissors gameplay.  Advanced mode adds Lizard and Spock for increased difficulty.
...
# Resources
* [Front End Site - Hosted on Netlify](https://rock-paper-scissors-adm.netlify.com/)

# Frontend Mentor - Rock, Paper, Scissors README Below
